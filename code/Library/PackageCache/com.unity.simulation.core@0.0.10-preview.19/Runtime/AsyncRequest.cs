...
namespace Unity.Simulation
{
    ...
    public abstract class AsyncRequest
    {
        ...
        /// This applies to asynchronous requests only, ExecutionContext.ThreadPool and ExecutionContext.JobSystem
        /// </summary>
    ...
    public class AsyncRequest<T> : AsyncRequest, IDisposable
    {
        ...
        public override void Complete()
        {
            ...
            {
                case ExecutionContext.JobSystem:
                    Debug.Assert(started == true, "AsyncRequest.Complete called on a request that hasn't been executed");
                ...
                default:
                    throw new InvalidOperationException("AsyncRequest.Complete called with unhandled execution context.");
            }
        }
